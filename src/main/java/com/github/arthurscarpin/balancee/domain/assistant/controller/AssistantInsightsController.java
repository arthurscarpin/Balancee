package com.github.arthurscarpin.balancee.domain.assistant.controller;

import com.github.arthurscarpin.balancee.domain.assistant.service.OpenAIService;
...
public class AssistantInsightsController {
    ...
    public Mono<ResponseEntity<String>> generateInsights(@PathVariable Long id) {
        List<TransactionResponse> transactionsDto = transactionService.findByUserId(id);
